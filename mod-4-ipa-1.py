...
def tic_tac_toe(board):
    ...
    if len(board) == 3:
        ...
        diagonal_ud = sum([points[i][j] for i, n in enumerate(points)])
        ...
        for i in v_sums:
            if i == 60:
                ...
                return print('O')
        if i in diagonal_ud == 60:
                return print('X')
        if i in diagonal_ud == 45:
                return print('O')
        if i in diagonal_du == 60:
                return print('X')
        if i in diagonal_du == 45:
                return print('O')
        else:
        ...
        points = [y[k:k+3] for k in range (0, len(y), 4)]
        ...
        for i in v_sums:
            if i == 80:
                ...
                return print('O')
        if i in diagonal_ud == 80:
                return print('X')
        if i in diagonal_ud == 60:
                return print('O')
        if i in diagonal_du == 80:
                return print('X')
        if i in diagonal_du == 60:
                return print('O')
        else:
        ...
        points = [y[k:k+3] for k in range (0, len(y), 5)]
        ...
        for i in v_sums:
            if i == 100:
                ...
                return print('O')
        if i in diagonal_ud == 100:
                return print('X')
        if i in diagonal_ud == 75:
                return print('O')
        if i in diagonal_du == 100:
                return print('X')
        if i in diagonal_du == 75:
                return print('O')
        else:
                return print('No Winner') 
        ...
        points = [y[k:k+3] for k in range (0, len(y), 6)]
        ...
        for i in v_sums:
            if i == 120:
                ...
                return print('O')
        if i in diagonal_ud == 120:
                return print('X')
        if i in diagonal_ud == 90:
                return print('O')
        if i in diagonal_du == 120:
                return print('X')
        if i in diagonal_du == 90:
                return print('O')
        else:
                return print('No Winner')
